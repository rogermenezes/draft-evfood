...
<%@ page import='com.rogermenezes.evfoodapp.*' %>
...
<%!
   ...
   */
  static final String consumerKey = "rogermenezes";
  static final String consumerSecret = "87b50cffe2e73e87";
...
<% } %>
	...
	<li>
<% if (accessToken != null) { %>
  <a href="/evfoodapp/wall">List notebooks in account</a><br/>
<% } else { %>
